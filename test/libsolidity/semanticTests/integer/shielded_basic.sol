contract C {
	function basic() public pure returns(bool) {
		...
		require(suint_max == 2**256 - 1);
		require(suint_max == 115792089237316195423570985008687907853269984665640564039457584007913129639935);
		...
		require(sint_max == 2**255 -1);
		require(sint_max == 57896044618658097711785492504343953926634992332820282019728792003956564819967);
